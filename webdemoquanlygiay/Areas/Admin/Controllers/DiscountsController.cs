...
namespace webdemoquanlygiay.Areas.Admin.Controllers
{
    public class DiscountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "discountID,discountCode,value,conditionMoney,note,startDate,endDate,image")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "discountID,discountCode,value,conditionMoney,note,startDate,endDate,image")] Discount discount)
        {
            if (ModelState.IsValid)
            {
