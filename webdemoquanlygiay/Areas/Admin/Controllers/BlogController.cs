    ...
    public class BlogController : Controller
    {
        ...
        public ActionResult createBlog(Blog blog, HttpPostedFileBase ImageUpload)
        {
            ...
            if (ImageUpload != null)
            {
                ...
                fileName += extension;
                blog.image = "~/Public/images/blog/" + fileName;
                ImageUpload.SaveAs(Path.Combine(Server.MapPath("~/Public/images/blog/"), fileName));
                db.Blogs.Add(blog);
                db.SaveChanges();
            ...
            {
                blog.image = "~/Public/images/blog/none.png";
                db.Blogs.Add(blog);
                db.SaveChanges();
                return RedirectToAction("BlogList");
            }
